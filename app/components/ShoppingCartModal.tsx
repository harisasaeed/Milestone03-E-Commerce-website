      ...
      <SheetContent className="sm:max-w-lg w-[90vw]">
       ...
       <div className="h-full flex flex-col justify-between">
                            ...
                            <div className="ml-4 flex flex-1 flex-col">
                                ...
                                <div className="flex flex-1 items-end justify-between text-sm">
                                    ...
                                    <div className="flex">
                                        ...
                                        className="font-medium text-primary hover:text-primary/80 text-red-600">
                                        Remove
                                        </button>
        ...
        <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
            ...
            <div className="mt-6">
                <Button className="w-full bg-red-500 text-white hover:bg-orange-500">
                    Checkout
            ...
            <div className="mt-6 flex justify-center text-center text-sm text-gray-400" >
             <p>
                OR <button onClick={()=>handleCartClick()} className="font-medium text-primary text-red-500 hover:text-white">Continue Shopping</button>
             </p>
            </div>
